...
export const metadata: Metadata = {
    ...
    description: "Servicio profesional de limpieza y desinfección de aljibes y depósitos de agua. Cumplimiento del RD 487/2022. Garantía de potabilidad y salubridad.",
};
            ...
            <section className="bg-slate-900 py-20 text-white relative">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <p className="text-xl text-blue-100 max-w-3xl">
                        Realizamos la limpieza y desinfección exhaustiva de aljibes en comunidades de propietarios, hoteles y complejos residenciales, asegurando que los depósitos de almacenamiento mantengan las condiciones higiénicas necesarias para el consumo humano.
                    </p>
                </div>
            </section>
