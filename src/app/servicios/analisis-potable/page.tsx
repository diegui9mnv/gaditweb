...
export const metadata: Metadata = {
    ...
    description: "Servicio de análisis de potabilidad del agua para comunidades, pozos y aljibes, asegurando el cumplimiento del Real Decreto 3/2023.",
};
            ...
            <section className="bg-slate-900 py-20 text-white relative">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <p className="text-xl text-green-100 max-w-3xl">
                        Cercioramos la salubridad del agua de consumo mediante un control analítico riguroso, fundamental para asegurar la salud pública bajo el marco del Real Decreto 3/2023.
                    </p>
                </div>
            </section>
